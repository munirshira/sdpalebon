    ...
    <body>
        ...
        <div class="bg">
            <div class="tulisan">
                ...
                <br>
                <h1><b>FASILITAS</b></h1>
                <p><a href="home_pengunjung.php">Home</a> / Fasilitas</p>
                <br>
                <br>
            </div>
        </div>
            ...
            <?php
                ...
                if (!$result){
                    ...
                    while ($row = $result->fetch_object()){
                        ...
                        echo '<img class="card-img-top" src="images/'.$row->gambar_fasilitas.'" alt="Card image cap" style="width:100%;">';
                        echo '<div class="card-body">';
                        echo '<p class="card-title" style="font-size:20px;"><b>'.$row->nama_fasilitas.'</b></p>';
