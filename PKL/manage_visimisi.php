        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link">Manage Visi Misi</a>
                        </li>
                    </ul>
                </div>
            </nav>
            <?php
                if(isset($_GET['v_visi'])){
                    $v_visi = $_GET['v_visi'];
                    if($v_visi == "edit true"){
                        echo'<div class="alert alert-success alert-dismissible">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Success!</strong> Visi berhasil diubah.
                        </div>';
                    }elseif($v_visi == "edit false"){
                        echo '<div class="alert alert-danger alert-dismissible">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Failed!</strong> Visi gagal diubah. 
                        </div>';
                    }
                }
            ?>
            ...
            <?php
                ...
                if (!$result){
                    ...
                    while ($row = $result->fetch_object()){
                        echo '<p style="font-weight:bold;">'.$row->isi.'</p>';
            ...
            ?>
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-body">
                        <form role="form" action="edit_visi.php" method="get">
                            <?php
                                $sql = "SELECT * FROM profil WHERE kategori='visi'";
                                $result = mysqli_query($db,$sql);
                                if (!$result){
                            ...
                            <textarea type="text" name="visi" class="form-control" required><?php echo $row->isi; ?></textarea>  
                            </div>
                ...
                <div class="line"></div>
                <?php
                    if(isset($_GET['v_misi'])){
                        $v_misi = $_GET['v_misi'];
                        if($v_misi == "edit true"){
                            echo'<div class="alert alert-success alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Success!</strong> Misi berhasil diubah.
                            </div>';
                        }elseif($v_misi == "edit false"){
                            echo '<div class="alert alert-danger alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Failed!</strong> Misi gagal diubah. 
                            </div>';
                        }elseif($v_misi == "add true"){
                            echo'<div class="alert alert-primary alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Success!</strong> Misi berhasil ditambahkan.
                            </div>';
                        }elseif($v_misi == "add false"){
                            echo '<div class="alert alert-danger alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Failed!</strong> Misi gagal ditambahkan. 
                            </div>';
                        }elseif($v_misi == "delete true"){
                            echo'<div class="alert alert-secondary alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Success!</strong> Misi berhasil dihapus.
                            </div>';
                        }elseif($v_misi == "delete false"){
                            echo '<div class="alert alert-danger alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Failed!</strong> Misi gagal ditambahkan. 
                            </div>';
                ...
                ?>
                <h4>Misi</h4>
                <a href="#" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModaladdmisi">Tambahkan Misi</a><br /><br />
					<table class="table">
                        <thead>
						<tr>
                            <th>No.</th>
                        ...
                        <tbody>
                        <?php 
                            $query = mysqli_query($db, "SELECT * FROM profil WHERE kategori='misi'");
                            $no = 1;
                            ...
                            ?>
                                ...
                                <td>
                                    <!-- Button untuk modal -->
                                    <a href="#" type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal<?php echo $data['id_profil']; ?>">Edit</a>
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin untuk menghapus misi ini?')" href="delete_misi.php?id=<?php echo $data['id_profil'];?>">Delete</a>
                                </td>
                                </tr>
                                <!-- Modal Edit Mahasiswa-->
                                <div class="modal fade bd-example-modal-lg" id="myModal<?php echo $data['id_profil']; ?>" role="dialog">
                                <div class="modal-dialog modal-lg">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form role="form" action="edit_misi.php" method="get">
                                            <?php
                                            $id = $data['id_profil']; 
                                            $query_edit = mysqli_query($db, "SELECT * FROM profil WHERE id_profil='$id'");
                                            while ($row = mysqli_fetch_array($query_edit)) {  
                                            ?>
                                            <input type="hidden" name="id_misi" value="<?php echo $row['id_profil']; ?>">
                                            <div class="form-group">
                                            <label>Misi</label>
                                            <textarea type="text" name="edit_misi" class="form-control" required><?php echo $row['isi']; ?></textarea>      
                                            </div>
                                            <div class="modal-footer">  
                                            <button type="submit" class="btn btn-success">Update</button>
                ...
                <div class="modal fade bd-example-modal-lg" id="myModaladdmisi" role="dialog">
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Tambahkan Misi</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>   
                    </div>
                    <div class="modal-body">
                        <form role="form" action="add_misi.php" method="get">
                            <div class="form-group">
                            <textarea type="text" name="add_misi" class="form-control" required></textarea>  
                            </div>
                            <div class="modal-footer">  
